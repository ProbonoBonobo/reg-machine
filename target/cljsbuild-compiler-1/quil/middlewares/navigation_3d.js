...
var vec__56750 = axis;
var a_x = cljs.core.nth.call(null,vec__56750,(0),null);
var a_y = cljs.core.nth.call(null,vec__56750,(1),null);
var a_z = cljs.core.nth.call(null,vec__56750,(2),null);
var vec__56753 = v;
var x = cljs.core.nth.call(null,vec__56753,(0),null);
var y = cljs.core.nth.call(null,vec__56753,(1),null);
var z = cljs.core.nth.call(null,vec__56753,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__56756,p__56757){
var vec__56764 = p__56756;
var u1 = cljs.core.nth.call(null,vec__56764,(0),null);
var u2 = cljs.core.nth.call(null,vec__56764,(1),null);
var u3 = cljs.core.nth.call(null,vec__56764,(2),null);
var vec__56767 = p__56757;
var v1 = cljs.core.nth.call(null,vec__56767,(0),null);
var v2 = cljs.core.nth.call(null,vec__56767,(1),null);
var v3 = cljs.core.nth.call(null,vec__56767,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__56770_SHARP_){
return (p1__56770_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__56771_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__56772_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__56772_SHARP_,angle_lr),angle_ud);
...
var map__56779 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__56779__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__56779__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__56781 = cljs.core._EQ_;
var expr__56782 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__56781.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__56782))){
return straight;
} else {
if(cljs.core.truth_(pred__56781.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__56782))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__56781.call(null,quil.middlewares.navigation_3d.space,expr__56782))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__56781.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__56782))){
return up;
} else {
if(cljs.core.truth_(pred__56781.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__56782))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__56781.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__56782))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__56779,map__56779__$1,up,straight){
return (function (p1__56773_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__56773_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__56779,map__56779__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__56784_SHARP_);
});})(initial_state))
);
});
/**
...
var map__56796_56807 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__56796_56808__$1 = ((((!((map__56796_56807 == null)))?((((map__56796_56807.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56796_56807.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56796_56807):map__56796_56807);
var vec__56797_56809 = cljs.core.get.call(null,map__56796_56808__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_56810 = cljs.core.nth.call(null,vec__56797_56809,(0),null);
var c_y_56811 = cljs.core.nth.call(null,vec__56797_56809,(1),null);
var c_z_56812 = cljs.core.nth.call(null,vec__56797_56809,(2),null);
var vec__56800_56813 = cljs.core.get.call(null,map__56796_56808__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_56814 = cljs.core.nth.call(null,vec__56800_56813,(0),null);
var u_y_56815 = cljs.core.nth.call(null,vec__56800_56813,(1),null);
var u_z_56816 = cljs.core.nth.call(null,vec__56800_56813,(2),null);
var vec__56803_56817 = cljs.core.get.call(null,map__56796_56808__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_56818 = cljs.core.nth.call(null,vec__56803_56817,(0),null);
var p_y_56819 = cljs.core.nth.call(null,vec__56803_56817,(1),null);
var p_z_56820 = cljs.core.nth.call(null,vec__56803_56817,(2),null);
quil.core.camera.call(null,p_x_56818,p_y_56819,p_z_56820,(p_x_56818 + c_x_56810),(p_y_56819 + c_y_56811),(p_z_56820 + c_z_56812),u_x_56814,u_y_56815,u_z_56816);
