...
var vec__34325 = axis;
var a_x = cljs.core.nth.call(null,vec__34325,(0),null);
var a_y = cljs.core.nth.call(null,vec__34325,(1),null);
var a_z = cljs.core.nth.call(null,vec__34325,(2),null);
var vec__34328 = v;
var x = cljs.core.nth.call(null,vec__34328,(0),null);
var y = cljs.core.nth.call(null,vec__34328,(1),null);
var z = cljs.core.nth.call(null,vec__34328,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__34331,p__34332){
var vec__34339 = p__34331;
var u1 = cljs.core.nth.call(null,vec__34339,(0),null);
var u2 = cljs.core.nth.call(null,vec__34339,(1),null);
var u3 = cljs.core.nth.call(null,vec__34339,(2),null);
var vec__34342 = p__34332;
var v1 = cljs.core.nth.call(null,vec__34342,(0),null);
var v2 = cljs.core.nth.call(null,vec__34342,(1),null);
var v3 = cljs.core.nth.call(null,vec__34342,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__34345_SHARP_){
return (p1__34345_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__34346_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__34347_SHARP_,angle_lr),angle_ud);
...
var map__34354 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__34354__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__34354__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__34356 = cljs.core._EQ_;
var expr__34357 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__34356.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__34357))){
return straight;
} else {
if(cljs.core.truth_(pred__34356.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__34357))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__34356.call(null,quil.middlewares.navigation_3d.space,expr__34357))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__34356.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__34357))){
return up;
} else {
if(cljs.core.truth_(pred__34356.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__34357))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__34356.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__34357))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__34354,map__34354__$1,up,straight){
return (function (p1__34348_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__34348_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__34354,map__34354__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__34359_SHARP_);
});})(initial_state))
);
});
/**
...
var map__34371_34382 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__34371_34383__$1 = ((((!((map__34371_34382 == null)))?((((map__34371_34382.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34371_34382.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34371_34382):map__34371_34382);
var vec__34372_34384 = cljs.core.get.call(null,map__34371_34383__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_34385 = cljs.core.nth.call(null,vec__34372_34384,(0),null);
var c_y_34386 = cljs.core.nth.call(null,vec__34372_34384,(1),null);
var c_z_34387 = cljs.core.nth.call(null,vec__34372_34384,(2),null);
var vec__34375_34388 = cljs.core.get.call(null,map__34371_34383__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_34389 = cljs.core.nth.call(null,vec__34375_34388,(0),null);
var u_y_34390 = cljs.core.nth.call(null,vec__34375_34388,(1),null);
var u_z_34391 = cljs.core.nth.call(null,vec__34375_34388,(2),null);
var vec__34378_34392 = cljs.core.get.call(null,map__34371_34383__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_34393 = cljs.core.nth.call(null,vec__34378_34392,(0),null);
var p_y_34394 = cljs.core.nth.call(null,vec__34378_34392,(1),null);
var p_z_34395 = cljs.core.nth.call(null,vec__34378_34392,(2),null);
quil.core.camera.call(null,p_x_34393,p_y_34394,p_z_34395,(p_x_34393 + c_x_34385),(p_y_34394 + c_y_34386),(p_z_34395 + c_z_34387),u_x_34389,u_y_34390,u_z_34391);
