...
var vec__48795 = axis;
var a_x = cljs.core.nth.call(null,vec__48795,(0),null);
var a_y = cljs.core.nth.call(null,vec__48795,(1),null);
var a_z = cljs.core.nth.call(null,vec__48795,(2),null);
var vec__48798 = v;
var x = cljs.core.nth.call(null,vec__48798,(0),null);
var y = cljs.core.nth.call(null,vec__48798,(1),null);
var z = cljs.core.nth.call(null,vec__48798,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__48801,p__48802){
var vec__48809 = p__48801;
var u1 = cljs.core.nth.call(null,vec__48809,(0),null);
var u2 = cljs.core.nth.call(null,vec__48809,(1),null);
var u3 = cljs.core.nth.call(null,vec__48809,(2),null);
var vec__48812 = p__48802;
var v1 = cljs.core.nth.call(null,vec__48812,(0),null);
var v2 = cljs.core.nth.call(null,vec__48812,(1),null);
var v3 = cljs.core.nth.call(null,vec__48812,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__48815_SHARP_){
return (p1__48815_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__48816_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__48817_SHARP_,angle_lr),angle_ud);
...
var map__48824 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__48824__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__48824__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__48826 = cljs.core._EQ_;
var expr__48827 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__48826.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__48827))){
return straight;
} else {
if(cljs.core.truth_(pred__48826.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__48827))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__48826.call(null,quil.middlewares.navigation_3d.space,expr__48827))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__48826.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__48827))){
return up;
} else {
if(cljs.core.truth_(pred__48826.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__48827))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__48826.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__48827))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__48824,map__48824__$1,up,straight){
return (function (p1__48818_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__48818_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__48824,map__48824__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__48829_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__48829_SHARP_);
});})(initial_state))
);
});
/**
...
var map__48841_48852 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__48841_48853__$1 = ((((!((map__48841_48852 == null)))?((((map__48841_48852.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48841_48852.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48841_48852):map__48841_48852);
var vec__48842_48854 = cljs.core.get.call(null,map__48841_48853__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_48855 = cljs.core.nth.call(null,vec__48842_48854,(0),null);
var c_y_48856 = cljs.core.nth.call(null,vec__48842_48854,(1),null);
var c_z_48857 = cljs.core.nth.call(null,vec__48842_48854,(2),null);
var vec__48845_48858 = cljs.core.get.call(null,map__48841_48853__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_48859 = cljs.core.nth.call(null,vec__48845_48858,(0),null);
var u_y_48860 = cljs.core.nth.call(null,vec__48845_48858,(1),null);
var u_z_48861 = cljs.core.nth.call(null,vec__48845_48858,(2),null);
var vec__48848_48862 = cljs.core.get.call(null,map__48841_48853__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_48863 = cljs.core.nth.call(null,vec__48848_48862,(0),null);
var p_y_48864 = cljs.core.nth.call(null,vec__48848_48862,(1),null);
var p_z_48865 = cljs.core.nth.call(null,vec__48848_48862,(2),null);
quil.core.camera.call(null,p_x_48863,p_y_48864,p_z_48865,(p_x_48863 + c_x_48855),(p_y_48864 + c_y_48856),(p_z_48865 + c_z_48857),u_x_48859,u_y_48860,u_z_48861);
