...
return cljs.core.merge.call(null,initial_state,p1__48868_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_48869 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_48870 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_48869);
var pos_48871 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_48869);
quil.core.scale.call(null,zoom_48870);

var tr__8210__auto___48872 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_48870) - cljs.core.first.call(null,pos_48871)),(((quil.core.height.call(null) / (2)) / zoom_48870) - cljs.core.second.call(null,pos_48871))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__8210__auto___48872);
