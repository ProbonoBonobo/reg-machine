...
var G__55618 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__55618;
continue;
} else {
return ch;
...
var vec__55622 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__55622,(0),null);
return (match === s);
});
...
var len__7651__auto___55627 = arguments.length;
var i__7652__auto___55628 = (0);
while(true){
if((i__7652__auto___55628 < len__7651__auto___55627)){
args__7658__auto__.push((arguments[i__7652__auto___55628]));

var G__55629 = (i__7652__auto___55628 + (1));
i__7652__auto___55628 = G__55629;
continue;
} else {
}
break;
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq55625){
var G__55626 = cljs.core.first.call(null,seq55625);
var seq55625__$1 = cljs.core.next.call(null,seq55625);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__55626,seq55625__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__55630__delegate = function (rdr,_){
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,msg);
};
var G__55630 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__55631__i = 0, G__55631__a = new Array(arguments.length -  1);
while (G__55631__i < G__55631__a.length) {G__55631__a[G__55631__i] = arguments[G__55631__i + 1]; ++G__55631__i;}
  _ = new cljs.core.IndexedSeq(G__55631__a,0);
} 
return G__55630__delegate.call(this,rdr,_);};
G__55630.cljs$lang$maxFixedArity = 1;
G__55630.cljs$lang$applyTo = (function (arglist__55632){
var rdr = cljs.core.first(arglist__55632);
var _ = cljs.core.rest(arglist__55632);
return G__55630__delegate(rdr,_);
});
