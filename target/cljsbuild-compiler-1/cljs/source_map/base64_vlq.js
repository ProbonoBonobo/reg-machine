...
var digit_57290 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_57291__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_57291__$1 > (0))){
var digit_57292__$1 = (digit_57290 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_57292__$1));

var G__57293 = (vlq_57291__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__57294 = (vlq_57291__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_57290 = G__57293;
vlq_57291__$1 = G__57294;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_57290));
}
break;
}
...
var G__57295 = i__$1;
var G__57296 = result__$1;
var G__57297 = shift__$1;
i = G__57295;
result = G__57296;
shift = G__57297;
continue;
