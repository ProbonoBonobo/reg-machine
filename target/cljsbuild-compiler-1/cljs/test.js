...
var args29813 = [];
var len__7651__auto___29817 = arguments.length;
var i__7652__auto___29818 = (0);
while(true){
if((i__7652__auto___29818 < len__7651__auto___29817)){
args29813.push((arguments[i__7652__auto___29818]));

var G__29819 = (i__7652__auto___29818 + (1));
i__7652__auto___29818 = G__29819;
continue;
} else {
}
break;
...
var G__29816 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__29816,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__29816;
}
});
...
var len__7651__auto___29824 = arguments.length;
var i__7652__auto___29825 = (0);
while(true){
if((i__7652__auto___29825 < len__7651__auto___29824)){
args__7658__auto__.push((arguments[i__7652__auto___29825]));

var G__29826 = (i__7652__auto___29825 + (1));
i__7652__auto___29825 = G__29826;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq29821){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__29822,G__29823,seq29821__$2);
});
...
var line = cljs.core.get.call(null,map__29830__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29830__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__29830,map__29830__$1,file,line,column){
return (function (p1__29827_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__29827_SHARP_));
});})(map__29830,map__29830__$1,file,line,column))
...
var temp__4657__auto___29832 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___29832)){
var message_29833 = temp__4657__auto___29832;
cljs.core.println.call(null,message_29833);
} else {
}
...
var temp__4657__auto___29834 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___29834)){
var message_29835 = temp__4657__auto___29834;
cljs.core.println.call(null,message_29835);
} else {
}
...
var G__29845 = exception.stack;
var G__29845__$1 = (((G__29845 == null))?null:clojure.string.split_lines.call(null,G__29845));
var G__29845__$2 = (((G__29845__$1 == null))?null:cljs.core.get.call(null,G__29845__$1,depth));
if((G__29845__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__29845__$2);
}
} else {
...
var vec__29846 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__29846,(0),null);
var column = cljs.core.nth.call(null,vec__29846,(1),null);
var vec__29849 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__29849,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__29849,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__29849,(2),null);
...
var m__$1 = (function (){var G__29853 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__29853) {
case "fail":
...
var G__29859 = (function (){var G__29858 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__29858);
} else {
return G__29858;
}
})();
...
return cljs.core.vary_meta.call(null,G__29861,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e29864){var e = e29864;
var G__29865 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__29865) {
...
var vec__29870 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__29870,(0),null);
var types = vec__29870;
...
return cljs.core.map.call(null,(function (p__29882){
var vec__29883 = p__29882;
var ns = cljs.core.nth.call(null,vec__29883,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__29883,(1),null);
return ((function (vec__29883,ns,vars__$1){
return (function (){
...
var G__29886 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__29886) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1){
return (function (){
var seq__29887 = cljs.core.seq.call(null,vars__$1);
var chunk__29888 = null;
var count__29889 = (0);
var i__29890 = (0);
while(true){
if((i__29890 < count__29889)){
var v = cljs.core._nth.call(null,chunk__29888,i__29890);
var temp__4657__auto___29892 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___29892)){
var t_29893 = temp__4657__auto___29892;
each_fixture_fn.call(null,((function (seq__29887,chunk__29888,count__29889,i__29890,t_29893,temp__4657__auto___29892,v,each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29893)));
});})(seq__29887,chunk__29888,count__29889,i__29890,t_29893,temp__4657__auto___29892,v,each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1))
);
} else {
}

var G__29894 = seq__29887;
var G__29895 = chunk__29888;
var G__29896 = count__29889;
var G__29897 = (i__29890 + (1));
seq__29887 = G__29894;
chunk__29888 = G__29895;
count__29889 = G__29896;
i__29890 = G__29897;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__29887);
if(temp__4657__auto__){
var seq__29887__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__29887__$1)){
var c__7357__auto__ = cljs.core.chunk_first.call(null,seq__29887__$1);
var G__29898 = cljs.core.chunk_rest.call(null,seq__29887__$1);
var G__29899 = c__7357__auto__;
var G__29900 = cljs.core.count.call(null,c__7357__auto__);
var G__29901 = (0);
seq__29887 = G__29898;
chunk__29888 = G__29899;
count__29889 = G__29900;
i__29890 = G__29901;
continue;
} else {
var v = cljs.core.first.call(null,seq__29887__$1);
var temp__4657__auto___29902__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___29902__$1)){
var t_29903 = temp__4657__auto___29902__$1;
each_fixture_fn.call(null,((function (seq__29887,chunk__29888,count__29889,i__29890,t_29903,temp__4657__auto___29902__$1,v,seq__29887__$1,temp__4657__auto__,each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29903)));
});})(seq__29887,chunk__29888,count__29889,i__29890,t_29903,temp__4657__auto___29902__$1,v,seq__29887__$1,temp__4657__auto__,each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1))
);
} else {
}

var G__29904 = cljs.core.next.call(null,seq__29887__$1);
var G__29905 = null;
var G__29906 = (0);
var G__29907 = (0);
seq__29887 = G__29904;
chunk__29888 = G__29905;
count__29889 = G__29906;
i__29890 = G__29907;
continue;
}
} else {
...
});})(each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1))
);
});})(each_fixture_fn,G__29886,env,once_fixtures,each_fixtures,vec__29883,ns,vars__$1))
], null);
