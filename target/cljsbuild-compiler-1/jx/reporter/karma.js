...
return [cljs.core.str("Fail "),cljs.core.str(cljs.test.testing_vars_str.call(null,p1__36751_SHARP_)),cljs.core.str("\n"),cljs.core.str("Expected "),cljs.core.str(cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(p1__36751_SHARP_))),cljs.core.str("\n"),cljs.core.str("Actual: "),cljs.core.str(cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(p1__36751_SHARP_))),cljs.core.str("\n")].join('');
});})(var_meta))
