...
if(typeof om_tools.core.t_om_tools$core35218 !== 'undefined'){
} else {
...
*/
om_tools.core.t_om_tools$core35218 = (function (state_proxy,owner,get_state,meta35219){
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_35220,meta35219__$1){
var self__ = this;
var _35220__$1 = this;
return (new om_tools.core.t_om_tools$core35218(self__.state_proxy,self__.owner,self__.get_state,meta35219__$1));
});})(get_state))
;

om_tools.core.t_om_tools$core35218.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
return (function (_35220){
var self__ = this;
var _35220__$1 = this;
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t_om_tools$core35218.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t_om_tools$core35218.getBasis = ((function (get_state){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"state-proxy","state-proxy",1999831324,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"owner","owner",1247919588,null)], null))),new cljs.core.Keyword(null,"doc","doc",1913296891),"Returns an atom-like object for reading and writing Om component\n   state.\n\n   Note: Behavior may exactly not match atoms when deref'ing\n   immediately following a reset!/swap! because Om processes state\n   changes asynchronously in separate render phases."], null)),new cljs.core.Symbol(null,"owner","owner",1247919588,null),new cljs.core.Symbol(null,"get-state","get-state",-1081972112,null),new cljs.core.Symbol(null,"meta35219","meta35219",1875693713,null)], null);
});})(get_state))
;

om_tools.core.t_om_tools$core35218.cljs$lang$type = true;

om_tools.core.t_om_tools$core35218.cljs$lang$ctorStr = "om-tools.core/t_om_tools$core35218";

om_tools.core.t_om_tools$core35218.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__7010__auto__,writer__7011__auto__,opt__7012__auto__){
return cljs.core._write.call(null,writer__7011__auto__,"om-tools.core/t_om_tools$core35218");
});})(get_state))
;

om_tools.core.__GT_t_om_tools$core35218 = ((function (get_state){
return (function om_tools$core$state_proxy_$___GT_t_om_tools$core35218(state_proxy__$1,owner__$1,get_state__$1,meta35219){
return (new om_tools.core.t_om_tools$core35218(state_proxy__$1,owner__$1,get_state__$1,meta35219));
});})(get_state))
;

}

return (new om_tools.core.t_om_tools$core35218(om_tools$core$state_proxy,owner,get_state,cljs.core.PersistentArrayMap.EMPTY));
} else {
return null;
}
});
...
var args35221 = [];
var len__7479__auto___35224 = arguments.length;
var i__7480__auto___35225 = (0);
while(true){
if((i__7480__auto___35225 < len__7479__auto___35224)){
args35221.push((arguments[i__7480__auto___35225]));

var G__35226 = (i__7480__auto___35225 + (1));
i__7480__auto___35225 = G__35226;
continue;
} else {
}
break;
