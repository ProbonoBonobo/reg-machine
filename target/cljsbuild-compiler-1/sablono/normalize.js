...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__62196_SHARP_){
return ((p1__62196_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__62196_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__62198,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__62198;
}
});
...
var len__7651__auto___62202 = arguments.length;
var i__7652__auto___62203 = (0);
while(true){
if((i__7652__auto___62203 < len__7651__auto___62202)){
args__7658__auto__.push((arguments[i__7652__auto___62203]));

var G__62204 = (i__7652__auto___62203 + (1));
i__7652__auto___62203 = G__62204;
continue;
} else {
}
break;
...
return (function (p1__62199_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__62199_SHARP_);
});})(maps__$1))
...
var G__62201 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__62201,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__62201;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq62200){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq62200));
});
...
var vec__62210 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__62210,(0),null);
var names = cljs.core.nth.call(null,vec__62210,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__62210,tag_name,names){
return (function (p1__62205_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__62205_SHARP_));
});})(matches,vec__62210,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__62210,tag_name,names){
return (function (p1__62206_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__62206_SHARP_));
});})(matches,vec__62210,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__62213){
var vec__62220 = p__62213;
var seq__62221 = cljs.core.seq.call(null,vec__62220);
var first__62222 = cljs.core.first.call(null,seq__62221);
var seq__62221__$1 = cljs.core.next.call(null,seq__62221);
var tag = first__62222;
var content = seq__62221__$1;
...
var vec__62223 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__62223,(0),null);
var id = cljs.core.nth.call(null,vec__62223,(1),null);
var class$ = cljs.core.nth.call(null,vec__62223,(2),null);
