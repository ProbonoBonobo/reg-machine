...
var m__7068__auto__ = (sablono.util.to_str[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return m__7068__auto__.call(null,x);
} else {
var m__7068__auto____$1 = (sablono.util.to_str["_"]);
...
var x__7067__auto__ = (((x == null))?null:x);
var m__7068__auto__ = (sablono.util.to_uri[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return m__7068__auto__.call(null,x);
} else {
var m__7068__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__7068__auto____$1 == null))){
return m__7068__auto____$1.call(null,x);
} else {
...
var len__7479__auto___28247 = arguments.length;
var i__7480__auto___28248 = (0);
while(true){
if((i__7480__auto___28248 < len__7479__auto___28247)){
args__7486__auto__.push((arguments[i__7480__auto___28248]));

var G__28249 = (i__7480__auto___28248 + (1));
i__7480__auto___28248 = G__28249;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__7487__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq28246){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28246));
});
...
var vec__28253 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__28255;
var words = seq__28254__$1;
...
var G__28257 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__28257,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__28257;
}
} else {
...
var args__7486__auto__ = [];
var len__7479__auto___28260 = arguments.length;
var i__7480__auto___28261 = (0);
while(true){
if((i__7480__auto___28261 < len__7479__auto___28260)){
args__7486__auto__.push((arguments[i__7480__auto___28261]));

var G__28262 = (i__7480__auto___28261 + (1));
i__7480__auto___28261 = G__28262;
continue;
} else {
}
break;
...
var argseq__7487__auto__ = ((((0) < args__7486__auto__.length))?(new cljs.core.IndexedSeq(args__7486__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__7487__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__28258_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__28258_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__28258_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__28258_SHARP_)){
return p1__28258_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__28258_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq28259){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28259));
});
...
var vec__28268 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__28268,(0),null);
var names = cljs.core.nth.call(null,vec__28268,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__28268,tag_name,names){
return (function (p1__28263_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__28263_SHARP_));
});})(matches,vec__28268,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__28268,tag_name,names){
return (function (p1__28264_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__28264_SHARP_));
});})(matches,vec__28268,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__28271){
var vec__28278 = p__28271;
...
var tag = first__28280;
var content = seq__28279__$1;
...
var vec__28281 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__28281,(0),null);
var id = cljs.core.nth.call(null,vec__28281,(1),null);
var class$ = cljs.core.nth.call(null,vec__28281,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__6404__auto__ = x__$1.hasDomain();
