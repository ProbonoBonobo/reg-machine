...
var vec__67698 = axis;
var a_x = cljs.core.nth.call(null,vec__67698,(0),null);
var a_y = cljs.core.nth.call(null,vec__67698,(1),null);
var a_z = cljs.core.nth.call(null,vec__67698,(2),null);
var vec__67701 = v;
var x = cljs.core.nth.call(null,vec__67701,(0),null);
var y = cljs.core.nth.call(null,vec__67701,(1),null);
var z = cljs.core.nth.call(null,vec__67701,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__67704,p__67705){
var vec__67712 = p__67704;
var u1 = cljs.core.nth.call(null,vec__67712,(0),null);
var u2 = cljs.core.nth.call(null,vec__67712,(1),null);
var u3 = cljs.core.nth.call(null,vec__67712,(2),null);
var vec__67715 = p__67705;
var v1 = cljs.core.nth.call(null,vec__67715,(0),null);
var v2 = cljs.core.nth.call(null,vec__67715,(1),null);
var v3 = cljs.core.nth.call(null,vec__67715,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__67718_SHARP_){
return (p1__67718_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__67719_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__67720_SHARP_,angle_lr),angle_ud);
...
var map__67727 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__67727__$1 = ((((!((map__67727 == null)))?((((map__67727.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67727.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67727):map__67727);
var up = cljs.core.get.call(null,map__67727__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__67727__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__67729 = cljs.core._EQ_;
var expr__67730 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__67729.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__67730))){
return straight;
} else {
if(cljs.core.truth_(pred__67729.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__67730))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__67729.call(null,quil.middlewares.navigation_3d.space,expr__67730))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__67729.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__67730))){
return up;
} else {
if(cljs.core.truth_(pred__67729.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__67730))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__67729.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__67730))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__67727,map__67727__$1,up,straight){
return (function (p1__67721_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__67721_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__67727,map__67727__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__67732_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__67732_SHARP_);
});})(initial_state))
);
});
/**
...
var map__67744_67755 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__67744_67756__$1 = ((((!((map__67744_67755 == null)))?((((map__67744_67755.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67744_67755.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67744_67755):map__67744_67755);
var vec__67745_67757 = cljs.core.get.call(null,map__67744_67756__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_67758 = cljs.core.nth.call(null,vec__67745_67757,(0),null);
var c_y_67759 = cljs.core.nth.call(null,vec__67745_67757,(1),null);
var c_z_67760 = cljs.core.nth.call(null,vec__67745_67757,(2),null);
var vec__67748_67761 = cljs.core.get.call(null,map__67744_67756__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_67762 = cljs.core.nth.call(null,vec__67748_67761,(0),null);
var u_y_67763 = cljs.core.nth.call(null,vec__67748_67761,(1),null);
var u_z_67764 = cljs.core.nth.call(null,vec__67748_67761,(2),null);
var vec__67751_67765 = cljs.core.get.call(null,map__67744_67756__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_67766 = cljs.core.nth.call(null,vec__67751_67765,(0),null);
var p_y_67767 = cljs.core.nth.call(null,vec__67751_67765,(1),null);
var p_z_67768 = cljs.core.nth.call(null,vec__67751_67765,(2),null);
quil.core.camera.call(null,p_x_67766,p_y_67767,p_z_67768,(p_x_67766 + c_x_67758),(p_y_67767 + c_y_67759),(p_z_67768 + c_z_67760),u_x_67762,u_y_67763,u_z_67764);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1479783857120