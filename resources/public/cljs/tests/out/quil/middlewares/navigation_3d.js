...
var vec__44960 = axis;
var a_x = cljs.core.nth.call(null,vec__44960,(0),null);
var a_y = cljs.core.nth.call(null,vec__44960,(1),null);
var a_z = cljs.core.nth.call(null,vec__44960,(2),null);
var vec__44963 = v;
var x = cljs.core.nth.call(null,vec__44963,(0),null);
var y = cljs.core.nth.call(null,vec__44963,(1),null);
var z = cljs.core.nth.call(null,vec__44963,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__44966,p__44967){
var vec__44974 = p__44966;
var u1 = cljs.core.nth.call(null,vec__44974,(0),null);
var u2 = cljs.core.nth.call(null,vec__44974,(1),null);
var u3 = cljs.core.nth.call(null,vec__44974,(2),null);
var vec__44977 = p__44967;
var v1 = cljs.core.nth.call(null,vec__44977,(0),null);
var v2 = cljs.core.nth.call(null,vec__44977,(1),null);
var v3 = cljs.core.nth.call(null,vec__44977,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__44980_SHARP_){
return (p1__44980_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__44981_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__44981_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__44982_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__44982_SHARP_,angle_lr),angle_ud);
...
var map__44989 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__44989__$1 = ((((!((map__44989 == null)))?((((map__44989.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44989.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44989):map__44989);
var up = cljs.core.get.call(null,map__44989__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__44989__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__44991 = cljs.core._EQ_;
var expr__44992 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__44991.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__44992))){
return straight;
} else {
if(cljs.core.truth_(pred__44991.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__44992))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__44991.call(null,quil.middlewares.navigation_3d.space,expr__44992))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__44991.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__44992))){
return up;
} else {
if(cljs.core.truth_(pred__44991.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__44992))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__44991.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__44992))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__44989,map__44989__$1,up,straight){
return (function (p1__44983_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__44983_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__44989,map__44989__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__44994_SHARP_);
});})(initial_state))
);
});
/**
...
var map__45006_45017 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__45006_45018__$1 = ((((!((map__45006_45017 == null)))?((((map__45006_45017.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45006_45017.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45006_45017):map__45006_45017);
var vec__45007_45019 = cljs.core.get.call(null,map__45006_45018__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_45020 = cljs.core.nth.call(null,vec__45007_45019,(0),null);
var c_y_45021 = cljs.core.nth.call(null,vec__45007_45019,(1),null);
var c_z_45022 = cljs.core.nth.call(null,vec__45007_45019,(2),null);
var vec__45010_45023 = cljs.core.get.call(null,map__45006_45018__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_45024 = cljs.core.nth.call(null,vec__45010_45023,(0),null);
var u_y_45025 = cljs.core.nth.call(null,vec__45010_45023,(1),null);
var u_z_45026 = cljs.core.nth.call(null,vec__45010_45023,(2),null);
var vec__45013_45027 = cljs.core.get.call(null,map__45006_45018__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_45028 = cljs.core.nth.call(null,vec__45013_45027,(0),null);
var p_y_45029 = cljs.core.nth.call(null,vec__45013_45027,(1),null);
var p_z_45030 = cljs.core.nth.call(null,vec__45013_45027,(2),null);
quil.core.camera.call(null,p_x_45028,p_y_45029,p_z_45030,(p_x_45028 + c_x_45020),(p_y_45029 + c_y_45021),(p_z_45030 + c_z_45022),u_x_45024,u_y_45025,u_z_45026);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1479783235278