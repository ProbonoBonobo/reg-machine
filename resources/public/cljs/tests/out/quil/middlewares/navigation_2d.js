...
return cljs.core.merge.call(null,initial_state,p1__45033_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_45034 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_45035 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_45034);
var pos_45036 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_45034);
quil.core.scale.call(null,zoom_45035);

var tr__8210__auto___45037 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_45035) - cljs.core.first.call(null,pos_45036)),(((quil.core.height.call(null) / (2)) / zoom_45035) - cljs.core.second.call(null,pos_45036))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__8210__auto___45037);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1479783235336