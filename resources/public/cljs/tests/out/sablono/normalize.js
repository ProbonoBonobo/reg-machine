...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__42717_SHARP_){
return ((p1__42717_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__42717_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__42719,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__42719;
}
});
...
var len__7651__auto___42723 = arguments.length;
var i__7652__auto___42724 = (0);
while(true){
if((i__7652__auto___42724 < len__7651__auto___42723)){
args__7658__auto__.push((arguments[i__7652__auto___42724]));

var G__42725 = (i__7652__auto___42724 + (1));
i__7652__auto___42724 = G__42725;
continue;
} else {
}
break;
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__42720_SHARP_);
});})(maps__$1))
...
var G__42722 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__42722,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__42722;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq42721){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42721));
});
...
var vec__42731 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__42731,(0),null);
var names = cljs.core.nth.call(null,vec__42731,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__42731,tag_name,names){
return (function (p1__42726_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__42726_SHARP_));
});})(matches,vec__42731,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__42731,tag_name,names){
return (function (p1__42727_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__42727_SHARP_));
});})(matches,vec__42731,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__42734){
var vec__42741 = p__42734;
...
var tag = first__42743;
var content = seq__42742__$1;
...
var vec__42744 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__42744,(0),null);
var id = cljs.core.nth.call(null,vec__42744,(1),null);
var class$ = cljs.core.nth.call(null,vec__42744,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1479783230511