...
var len__7651__auto___65029 = arguments.length;
var i__7652__auto___65030 = (0);
while(true){
if((i__7652__auto___65030 < len__7651__auto___65029)){
args__7658__auto__.push((arguments[i__7652__auto___65030]));

var G__65031 = (i__7652__auto___65030 + (1));
i__7652__auto___65030 = G__65031;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq65028){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq65028));
});
...
var vec__65035 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__65036 = cljs.core.seq.call(null,vec__65035);
var first__65037 = cljs.core.first.call(null,seq__65036);
var seq__65036__$1 = cljs.core.next.call(null,seq__65036);
var first_word = first__65037;
var words = seq__65036__$1;
...
var G__65039 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__65039,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__65039;
}
} else {
...
//# sourceMappingURL=util.js.map?rel=1479783841598