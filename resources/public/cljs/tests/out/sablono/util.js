...
var len__7651__auto___42704 = arguments.length;
var i__7652__auto___42705 = (0);
while(true){
if((i__7652__auto___42705 < len__7651__auto___42704)){
args__7658__auto__.push((arguments[i__7652__auto___42705]));

var G__42706 = (i__7652__auto___42705 + (1));
i__7652__auto___42705 = G__42706;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq42703){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42703));
});
...
var vec__42710 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__42712;
var words = seq__42711__$1;
...
var G__42714 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__42714,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__42714;
}
} else {
...
//# sourceMappingURL=util.js.map?rel=1479783230417