...
var args58387 = [];
var len__7651__auto___58391 = arguments.length;
var i__7652__auto___58392 = (0);
while(true){
if((i__7652__auto___58392 < len__7651__auto___58391)){
args58387.push((arguments[i__7652__auto___58392]));

var G__58393 = (i__7652__auto___58392 + (1));
i__7652__auto___58392 = G__58393;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,G__58390,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__58390;
}
});
...
var len__7651__auto___58398 = arguments.length;
var i__7652__auto___58399 = (0);
while(true){
if((i__7652__auto___58399 < len__7651__auto___58398)){
args__7658__auto__.push((arguments[i__7652__auto___58399]));

var G__58400 = (i__7652__auto___58399 + (1));
i__7652__auto___58399 = G__58400;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq58395){
var G__58396 = cljs.core.first.call(null,seq58395);
var seq58395__$1 = cljs.core.next.call(null,seq58395);
var G__58397 = cljs.core.first.call(null,seq58395__$1);
var seq58395__$2 = cljs.core.next.call(null,seq58395__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__58396,G__58397,seq58395__$2);
});
...
var map__58404 = m;
var map__58404__$1 = ((((!((map__58404 == null)))?((((map__58404.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58404.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58404):map__58404);
var file = cljs.core.get.call(null,map__58404__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__58404__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__58404__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__58404,map__58404__$1,file,line,column){
return (function (p1__58401_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__58401_SHARP_));
});})(map__58404,map__58404__$1,file,line,column))
...
var temp__4657__auto___58406 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___58406)){
var message_58407 = temp__4657__auto___58406;
cljs.core.println.call(null,message_58407);
} else {
}
...
var temp__4657__auto___58408 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___58408)){
var message_58409 = temp__4657__auto___58408;
cljs.core.println.call(null,message_58409);
} else {
}
...
var G__58419 = exception.stack;
var G__58419__$1 = (((G__58419 == null))?null:clojure.string.split_lines.call(null,G__58419));
var G__58419__$2 = (((G__58419__$1 == null))?null:cljs.core.get.call(null,G__58419__$1,depth));
if((G__58419__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__58419__$2);
}
} else {
...
var vec__58420 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__58420,(0),null);
var column = cljs.core.nth.call(null,vec__58420,(1),null);
var vec__58423 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__58423,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__58423,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__58423,(2),null);
...
var m__$1 = (function (){var G__58427 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__58427) {
case "fail":
...
var G__58433 = (function (){var G__58432 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__58432);
} else {
return G__58432;
}
})();
...
return cljs.core.vary_meta.call(null,G__58435,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e58438){var e = e58438;
var G__58439 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__58439) {
...
var vec__58444 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__58444,(0),null);
var types = vec__58444;
...
return cljs.core.map.call(null,(function (p__58456){
var vec__58457 = p__58456;
var ns = cljs.core.nth.call(null,vec__58457,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__58457,(1),null);
return ((function (vec__58457,ns,vars__$1){
return (function (){
...
var G__58460 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__58460) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1){
return (function (){
var seq__58461 = cljs.core.seq.call(null,vars__$1);
var chunk__58462 = null;
var count__58463 = (0);
var i__58464 = (0);
while(true){
if((i__58464 < count__58463)){
var v = cljs.core._nth.call(null,chunk__58462,i__58464);
var temp__4657__auto___58466 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___58466)){
var t_58467 = temp__4657__auto___58466;
each_fixture_fn.call(null,((function (seq__58461,chunk__58462,count__58463,i__58464,t_58467,temp__4657__auto___58466,v,each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_58467)));
});})(seq__58461,chunk__58462,count__58463,i__58464,t_58467,temp__4657__auto___58466,v,each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1))
);
} else {
}

var G__58468 = seq__58461;
var G__58469 = chunk__58462;
var G__58470 = count__58463;
var G__58471 = (i__58464 + (1));
seq__58461 = G__58468;
chunk__58462 = G__58469;
count__58463 = G__58470;
i__58464 = G__58471;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__58461);
if(temp__4657__auto__){
var seq__58461__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__58461__$1)){
var c__7357__auto__ = cljs.core.chunk_first.call(null,seq__58461__$1);
var G__58472 = cljs.core.chunk_rest.call(null,seq__58461__$1);
var G__58473 = c__7357__auto__;
var G__58474 = cljs.core.count.call(null,c__7357__auto__);
var G__58475 = (0);
seq__58461 = G__58472;
chunk__58462 = G__58473;
count__58463 = G__58474;
i__58464 = G__58475;
continue;
} else {
var v = cljs.core.first.call(null,seq__58461__$1);
var temp__4657__auto___58476__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___58476__$1)){
var t_58477 = temp__4657__auto___58476__$1;
each_fixture_fn.call(null,((function (seq__58461,chunk__58462,count__58463,i__58464,t_58477,temp__4657__auto___58476__$1,v,seq__58461__$1,temp__4657__auto__,each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1){
return (function (){
...
});})(seq__58461,chunk__58462,count__58463,i__58464,t_58477,temp__4657__auto___58476__$1,v,seq__58461__$1,temp__4657__auto__,each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1))
);
} else {
}

var G__58478 = cljs.core.next.call(null,seq__58461__$1);
var G__58479 = null;
var G__58480 = (0);
var G__58481 = (0);
seq__58461 = G__58478;
chunk__58462 = G__58479;
count__58463 = G__58480;
i__58464 = G__58481;
continue;
}
} else {
...
});})(each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1))
);
});})(each_fixture_fn,G__58460,env,once_fixtures,each_fixtures,vec__58457,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1479783829844