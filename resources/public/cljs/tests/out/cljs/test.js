...
var args39613 = [];
var len__7651__auto___39617 = arguments.length;
var i__7652__auto___39618 = (0);
while(true){
if((i__7652__auto___39618 < len__7651__auto___39617)){
args39613.push((arguments[i__7652__auto___39618]));

var G__39619 = (i__7652__auto___39618 + (1));
i__7652__auto___39618 = G__39619;
continue;
} else {
}
break;
...
var G__39616 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__39616,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__39616;
}
});
...
var len__7651__auto___39624 = arguments.length;
var i__7652__auto___39625 = (0);
while(true){
if((i__7652__auto___39625 < len__7651__auto___39624)){
args__7658__auto__.push((arguments[i__7652__auto___39625]));

var G__39626 = (i__7652__auto___39625 + (1));
i__7652__auto___39625 = G__39626;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq39621){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39622,G__39623,seq39621__$2);
});
...
var file = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__39630,map__39630__$1,file,line,column){
return (function (p1__39627_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__39627_SHARP_));
});})(map__39630,map__39630__$1,file,line,column))
...
var temp__4657__auto___39632 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___39632)){
var message_39633 = temp__4657__auto___39632;
cljs.core.println.call(null,message_39633);
} else {
}
...
var temp__4657__auto___39634 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___39634)){
var message_39635 = temp__4657__auto___39634;
cljs.core.println.call(null,message_39635);
} else {
}
...
var G__39645 = exception.stack;
var G__39645__$1 = (((G__39645 == null))?null:clojure.string.split_lines.call(null,G__39645));
var G__39645__$2 = (((G__39645__$1 == null))?null:cljs.core.get.call(null,G__39645__$1,depth));
if((G__39645__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__39645__$2);
}
} else {
...
var vec__39646 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__39646,(0),null);
var column = cljs.core.nth.call(null,vec__39646,(1),null);
var vec__39649 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__39649,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__39649,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__39649,(2),null);
...
var m__$1 = (function (){var G__39653 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__39653) {
case "fail":
...
var G__39659 = (function (){var G__39658 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__39658);
} else {
return G__39658;
}
})();
...
return cljs.core.vary_meta.call(null,G__39661,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e39664){var e = e39664;
var G__39665 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__39665) {
...
var vec__39670 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__39670,(0),null);
var types = vec__39670;
...
return cljs.core.map.call(null,(function (p__39682){
var vec__39683 = p__39682;
var ns = cljs.core.nth.call(null,vec__39683,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__39683,(1),null);
return ((function (vec__39683,ns,vars__$1){
return (function (){
...
var G__39686 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__39686) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1){
return (function (){
var seq__39687 = cljs.core.seq.call(null,vars__$1);
var chunk__39688 = null;
var count__39689 = (0);
var i__39690 = (0);
while(true){
if((i__39690 < count__39689)){
var v = cljs.core._nth.call(null,chunk__39688,i__39690);
var temp__4657__auto___39692 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___39692)){
var t_39693 = temp__4657__auto___39692;
each_fixture_fn.call(null,((function (seq__39687,chunk__39688,count__39689,i__39690,t_39693,temp__4657__auto___39692,v,each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_39693)));
});})(seq__39687,chunk__39688,count__39689,i__39690,t_39693,temp__4657__auto___39692,v,each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1))
);
} else {
}

var G__39694 = seq__39687;
var G__39695 = chunk__39688;
var G__39696 = count__39689;
var G__39697 = (i__39690 + (1));
seq__39687 = G__39694;
chunk__39688 = G__39695;
count__39689 = G__39696;
i__39690 = G__39697;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__39687);
if(temp__4657__auto__){
var seq__39687__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__39687__$1)){
var c__7357__auto__ = cljs.core.chunk_first.call(null,seq__39687__$1);
var G__39698 = cljs.core.chunk_rest.call(null,seq__39687__$1);
var G__39699 = c__7357__auto__;
var G__39700 = cljs.core.count.call(null,c__7357__auto__);
var G__39701 = (0);
seq__39687 = G__39698;
chunk__39688 = G__39699;
count__39689 = G__39700;
i__39690 = G__39701;
continue;
} else {
var v = cljs.core.first.call(null,seq__39687__$1);
var temp__4657__auto___39702__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___39702__$1)){
var t_39703 = temp__4657__auto___39702__$1;
each_fixture_fn.call(null,((function (seq__39687,chunk__39688,count__39689,i__39690,t_39703,temp__4657__auto___39702__$1,v,seq__39687__$1,temp__4657__auto__,each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_39703)));
});})(seq__39687,chunk__39688,count__39689,i__39690,t_39703,temp__4657__auto___39702__$1,v,seq__39687__$1,temp__4657__auto__,each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1))
);
} else {
}

var G__39704 = cljs.core.next.call(null,seq__39687__$1);
var G__39705 = null;
var G__39706 = (0);
var G__39707 = (0);
seq__39687 = G__39704;
chunk__39688 = G__39705;
count__39689 = G__39706;
i__39690 = G__39707;
continue;
}
} else {
...
});})(each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1))
);
});})(each_fixture_fn,G__39686,env,once_fixtures,each_fixtures,vec__39683,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1479783226260