...
var vec__49514 = axis;
var a_x = cljs.core.nth.call(null,vec__49514,(0),null);
var a_y = cljs.core.nth.call(null,vec__49514,(1),null);
var a_z = cljs.core.nth.call(null,vec__49514,(2),null);
var vec__49517 = v;
var x = cljs.core.nth.call(null,vec__49517,(0),null);
var y = cljs.core.nth.call(null,vec__49517,(1),null);
var z = cljs.core.nth.call(null,vec__49517,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__49520,p__49521){
var vec__49528 = p__49520;
var u1 = cljs.core.nth.call(null,vec__49528,(0),null);
var u2 = cljs.core.nth.call(null,vec__49528,(1),null);
var u3 = cljs.core.nth.call(null,vec__49528,(2),null);
var vec__49531 = p__49521;
var v1 = cljs.core.nth.call(null,vec__49531,(0),null);
var v2 = cljs.core.nth.call(null,vec__49531,(1),null);
var v3 = cljs.core.nth.call(null,vec__49531,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__49534_SHARP_){
return (p1__49534_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__49535_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__49536_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__49536_SHARP_,angle_lr),angle_ud);
...
var map__49543 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__49543__$1 = ((((!((map__49543 == null)))?((((map__49543.cljs$lang$protocol_mask$partition0$ & (64))) || (map__49543.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49543):map__49543);
var up = cljs.core.get.call(null,map__49543__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__49543__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__49545 = cljs.core._EQ_;
var expr__49546 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__49545.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__49546))){
return straight;
} else {
if(cljs.core.truth_(pred__49545.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__49546))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__49545.call(null,quil.middlewares.navigation_3d.space,expr__49546))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__49545.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__49546))){
return up;
} else {
if(cljs.core.truth_(pred__49545.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__49546))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__49545.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__49546))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__49543,map__49543__$1,up,straight){
return (function (p1__49537_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__49537_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__49543,map__49543__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__49548_SHARP_);
});})(initial_state))
);
});
/**
...
var map__49560_49571 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__49560_49572__$1 = ((((!((map__49560_49571 == null)))?((((map__49560_49571.cljs$lang$protocol_mask$partition0$ & (64))) || (map__49560_49571.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49560_49571):map__49560_49571);
var vec__49561_49573 = cljs.core.get.call(null,map__49560_49572__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_49574 = cljs.core.nth.call(null,vec__49561_49573,(0),null);
var c_y_49575 = cljs.core.nth.call(null,vec__49561_49573,(1),null);
var c_z_49576 = cljs.core.nth.call(null,vec__49561_49573,(2),null);
var vec__49564_49577 = cljs.core.get.call(null,map__49560_49572__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_49578 = cljs.core.nth.call(null,vec__49564_49577,(0),null);
var u_y_49579 = cljs.core.nth.call(null,vec__49564_49577,(1),null);
var u_z_49580 = cljs.core.nth.call(null,vec__49564_49577,(2),null);
var vec__49567_49581 = cljs.core.get.call(null,map__49560_49572__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_49582 = cljs.core.nth.call(null,vec__49567_49581,(0),null);
var p_y_49583 = cljs.core.nth.call(null,vec__49567_49581,(1),null);
var p_z_49584 = cljs.core.nth.call(null,vec__49567_49581,(2),null);
quil.core.camera.call(null,p_x_49582,p_y_49583,p_z_49584,(p_x_49582 + c_x_49574),(p_y_49583 + c_y_49575),(p_z_49584 + c_z_49576),u_x_49578,u_y_49579,u_z_49580);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1478445861206