...
var vec__36026 = axis;
var a_x = cljs.core.nth.call(null,vec__36026,(0),null);
var a_y = cljs.core.nth.call(null,vec__36026,(1),null);
var a_z = cljs.core.nth.call(null,vec__36026,(2),null);
var vec__36029 = v;
var x = cljs.core.nth.call(null,vec__36029,(0),null);
var y = cljs.core.nth.call(null,vec__36029,(1),null);
var z = cljs.core.nth.call(null,vec__36029,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__36032,p__36033){
var vec__36040 = p__36032;
var u1 = cljs.core.nth.call(null,vec__36040,(0),null);
var u2 = cljs.core.nth.call(null,vec__36040,(1),null);
var u3 = cljs.core.nth.call(null,vec__36040,(2),null);
var vec__36043 = p__36033;
var v1 = cljs.core.nth.call(null,vec__36043,(0),null);
var v2 = cljs.core.nth.call(null,vec__36043,(1),null);
var v3 = cljs.core.nth.call(null,vec__36043,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__36046_SHARP_){
return (p1__36046_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__36047_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__36048_SHARP_,angle_lr),angle_ud);
...
var map__36055 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__36055__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__36055__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__36057 = cljs.core._EQ_;
var expr__36058 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__36057.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__36058))){
return straight;
} else {
if(cljs.core.truth_(pred__36057.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__36058))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__36057.call(null,quil.middlewares.navigation_3d.space,expr__36058))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__36057.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__36058))){
return up;
} else {
if(cljs.core.truth_(pred__36057.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__36058))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__36057.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__36058))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__36055,map__36055__$1,up,straight){
return (function (p1__36049_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__36049_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__36055,map__36055__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__36060_SHARP_);
});})(initial_state))
);
});
/**
...
var map__36072_36083 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__36072_36084__$1 = ((((!((map__36072_36083 == null)))?((((map__36072_36083.cljs$lang$protocol_mask$partition0$ & (64))) || (map__36072_36083.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36072_36083):map__36072_36083);
var vec__36073_36085 = cljs.core.get.call(null,map__36072_36084__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_36086 = cljs.core.nth.call(null,vec__36073_36085,(0),null);
var c_y_36087 = cljs.core.nth.call(null,vec__36073_36085,(1),null);
var c_z_36088 = cljs.core.nth.call(null,vec__36073_36085,(2),null);
var vec__36076_36089 = cljs.core.get.call(null,map__36072_36084__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_36090 = cljs.core.nth.call(null,vec__36076_36089,(0),null);
var u_y_36091 = cljs.core.nth.call(null,vec__36076_36089,(1),null);
var u_z_36092 = cljs.core.nth.call(null,vec__36076_36089,(2),null);
var vec__36079_36093 = cljs.core.get.call(null,map__36072_36084__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_36094 = cljs.core.nth.call(null,vec__36079_36093,(0),null);
var p_y_36095 = cljs.core.nth.call(null,vec__36079_36093,(1),null);
var p_z_36096 = cljs.core.nth.call(null,vec__36079_36093,(2),null);
quil.core.camera.call(null,p_x_36094,p_y_36095,p_z_36096,(p_x_36094 + c_x_36086),(p_y_36095 + c_y_36087),(p_z_36096 + c_z_36088),u_x_36090,u_y_36091,u_z_36092);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1479332392858