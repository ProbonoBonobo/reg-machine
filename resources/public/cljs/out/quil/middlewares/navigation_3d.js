...
var vec__55518 = axis;
var a_x = cljs.core.nth.call(null,vec__55518,(0),null);
var a_y = cljs.core.nth.call(null,vec__55518,(1),null);
var a_z = cljs.core.nth.call(null,vec__55518,(2),null);
var vec__55521 = v;
var x = cljs.core.nth.call(null,vec__55521,(0),null);
var y = cljs.core.nth.call(null,vec__55521,(1),null);
var z = cljs.core.nth.call(null,vec__55521,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__55524,p__55525){
var vec__55532 = p__55524;
var u1 = cljs.core.nth.call(null,vec__55532,(0),null);
var u2 = cljs.core.nth.call(null,vec__55532,(1),null);
var u3 = cljs.core.nth.call(null,vec__55532,(2),null);
var vec__55535 = p__55525;
var v1 = cljs.core.nth.call(null,vec__55535,(0),null);
var v2 = cljs.core.nth.call(null,vec__55535,(1),null);
var v3 = cljs.core.nth.call(null,vec__55535,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__55538_SHARP_){
return (p1__55538_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__55539_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__55539_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__55540_SHARP_,angle_lr),angle_ud);
...
var map__55547 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__55547__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__55547__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__55549 = cljs.core._EQ_;
var expr__55550 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__55549.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__55550))){
return straight;
} else {
if(cljs.core.truth_(pred__55549.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__55550))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__55549.call(null,quil.middlewares.navigation_3d.space,expr__55550))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__55549.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__55550))){
return up;
} else {
if(cljs.core.truth_(pred__55549.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__55550))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__55549.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__55550))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__55547,map__55547__$1,up,straight){
return (function (p1__55541_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__55541_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__55547,map__55547__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__55552_SHARP_);
});})(initial_state))
);
});
/**
...
var map__55564_55575 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__55564_55576__$1 = ((((!((map__55564_55575 == null)))?((((map__55564_55575.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55564_55575.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55564_55575):map__55564_55575);
var vec__55565_55577 = cljs.core.get.call(null,map__55564_55576__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_55578 = cljs.core.nth.call(null,vec__55565_55577,(0),null);
var c_y_55579 = cljs.core.nth.call(null,vec__55565_55577,(1),null);
var c_z_55580 = cljs.core.nth.call(null,vec__55565_55577,(2),null);
var vec__55568_55581 = cljs.core.get.call(null,map__55564_55576__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_55582 = cljs.core.nth.call(null,vec__55568_55581,(0),null);
var u_y_55583 = cljs.core.nth.call(null,vec__55568_55581,(1),null);
var u_z_55584 = cljs.core.nth.call(null,vec__55568_55581,(2),null);
var vec__55571_55585 = cljs.core.get.call(null,map__55564_55576__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_55586 = cljs.core.nth.call(null,vec__55571_55585,(0),null);
var p_y_55587 = cljs.core.nth.call(null,vec__55571_55585,(1),null);
var p_z_55588 = cljs.core.nth.call(null,vec__55571_55585,(2),null);
quil.core.camera.call(null,p_x_55586,p_y_55587,p_z_55588,(p_x_55586 + c_x_55578),(p_y_55587 + c_y_55579),(p_z_55588 + c_z_55580),u_x_55582,u_y_55583,u_z_55584);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1479783821357