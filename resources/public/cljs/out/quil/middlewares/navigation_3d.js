...
var vec__47122 = axis;
var a_x = cljs.core.nth.call(null,vec__47122,(0),null);
var a_y = cljs.core.nth.call(null,vec__47122,(1),null);
var a_z = cljs.core.nth.call(null,vec__47122,(2),null);
var vec__47125 = v;
var x = cljs.core.nth.call(null,vec__47125,(0),null);
var y = cljs.core.nth.call(null,vec__47125,(1),null);
var z = cljs.core.nth.call(null,vec__47125,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__47128,p__47129){
var vec__47136 = p__47128;
var u1 = cljs.core.nth.call(null,vec__47136,(0),null);
var u2 = cljs.core.nth.call(null,vec__47136,(1),null);
var u3 = cljs.core.nth.call(null,vec__47136,(2),null);
var vec__47139 = p__47129;
var v1 = cljs.core.nth.call(null,vec__47139,(0),null);
var v2 = cljs.core.nth.call(null,vec__47139,(1),null);
var v3 = cljs.core.nth.call(null,vec__47139,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__47142_SHARP_){
return (p1__47142_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__47143_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__47144_SHARP_,angle_lr),angle_ud);
...
var map__47151 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__47151__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__47151__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__47153 = cljs.core._EQ_;
var expr__47154 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__47153.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__47154))){
return straight;
} else {
if(cljs.core.truth_(pred__47153.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__47154))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__47153.call(null,quil.middlewares.navigation_3d.space,expr__47154))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__47153.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__47154))){
return up;
} else {
if(cljs.core.truth_(pred__47153.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__47154))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__47153.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__47154))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__47151,map__47151__$1,up,straight){
return (function (p1__47145_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__47145_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__47151,map__47151__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__47156_SHARP_);
});})(initial_state))
);
});
/**
...
var map__47168_47179 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__47168_47180__$1 = ((((!((map__47168_47179 == null)))?((((map__47168_47179.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47168_47179.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47168_47179):map__47168_47179);
var vec__47169_47181 = cljs.core.get.call(null,map__47168_47180__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_47182 = cljs.core.nth.call(null,vec__47169_47181,(0),null);
var c_y_47183 = cljs.core.nth.call(null,vec__47169_47181,(1),null);
var c_z_47184 = cljs.core.nth.call(null,vec__47169_47181,(2),null);
var vec__47172_47185 = cljs.core.get.call(null,map__47168_47180__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_47186 = cljs.core.nth.call(null,vec__47172_47185,(0),null);
var u_y_47187 = cljs.core.nth.call(null,vec__47172_47185,(1),null);
var u_z_47188 = cljs.core.nth.call(null,vec__47172_47185,(2),null);
var vec__47175_47189 = cljs.core.get.call(null,map__47168_47180__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_47190 = cljs.core.nth.call(null,vec__47175_47189,(0),null);
var p_y_47191 = cljs.core.nth.call(null,vec__47175_47189,(1),null);
var p_z_47192 = cljs.core.nth.call(null,vec__47175_47189,(2),null);
quil.core.camera.call(null,p_x_47190,p_y_47191,p_z_47192,(p_x_47190 + c_x_47182),(p_y_47191 + c_y_47183),(p_z_47192 + c_z_47184),u_x_47186,u_y_47187,u_z_47188);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1479783414788