...
var vec__56827 = axis;
var a_x = cljs.core.nth.call(null,vec__56827,(0),null);
var a_y = cljs.core.nth.call(null,vec__56827,(1),null);
var a_z = cljs.core.nth.call(null,vec__56827,(2),null);
var vec__56830 = v;
var x = cljs.core.nth.call(null,vec__56830,(0),null);
var y = cljs.core.nth.call(null,vec__56830,(1),null);
var z = cljs.core.nth.call(null,vec__56830,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__56833,p__56834){
var vec__56841 = p__56833;
var u1 = cljs.core.nth.call(null,vec__56841,(0),null);
var u2 = cljs.core.nth.call(null,vec__56841,(1),null);
var u3 = cljs.core.nth.call(null,vec__56841,(2),null);
var vec__56844 = p__56834;
var v1 = cljs.core.nth.call(null,vec__56844,(0),null);
var v2 = cljs.core.nth.call(null,vec__56844,(1),null);
var v3 = cljs.core.nth.call(null,vec__56844,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__56847_SHARP_){
return (p1__56847_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__56848_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__56849_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__56849_SHARP_,angle_lr),angle_ud);
...
var map__56856 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__56856__$1 = ((((!((map__56856 == null)))?((((map__56856.cljs$lang$protocol_mask$partition0$ & (64))) || (map__56856.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56856):map__56856);
var up = cljs.core.get.call(null,map__56856__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__56856__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__56858 = cljs.core._EQ_;
var expr__56859 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__56858.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__56859))){
return straight;
} else {
if(cljs.core.truth_(pred__56858.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__56859))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__56858.call(null,quil.middlewares.navigation_3d.space,expr__56859))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__56858.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__56859))){
return up;
} else {
if(cljs.core.truth_(pred__56858.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__56859))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__56858.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__56859))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__56856,map__56856__$1,up,straight){
return (function (p1__56850_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__56850_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__56856,map__56856__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__56861_SHARP_);
});})(initial_state))
);
});
/**
...
var map__56873_56884 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__56873_56885__$1 = ((((!((map__56873_56884 == null)))?((((map__56873_56884.cljs$lang$protocol_mask$partition0$ & (64))) || (map__56873_56884.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56873_56884):map__56873_56884);
var vec__56874_56886 = cljs.core.get.call(null,map__56873_56885__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_56887 = cljs.core.nth.call(null,vec__56874_56886,(0),null);
var c_y_56888 = cljs.core.nth.call(null,vec__56874_56886,(1),null);
var c_z_56889 = cljs.core.nth.call(null,vec__56874_56886,(2),null);
var vec__56877_56890 = cljs.core.get.call(null,map__56873_56885__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_56891 = cljs.core.nth.call(null,vec__56877_56890,(0),null);
var u_y_56892 = cljs.core.nth.call(null,vec__56877_56890,(1),null);
var u_z_56893 = cljs.core.nth.call(null,vec__56877_56890,(2),null);
var vec__56880_56894 = cljs.core.get.call(null,map__56873_56885__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_56895 = cljs.core.nth.call(null,vec__56880_56894,(0),null);
var p_y_56896 = cljs.core.nth.call(null,vec__56880_56894,(1),null);
var p_z_56897 = cljs.core.nth.call(null,vec__56880_56894,(2),null);
quil.core.camera.call(null,p_x_56895,p_y_56896,p_z_56897,(p_x_56895 + c_x_56887),(p_y_56896 + c_y_56888),(p_z_56897 + c_z_56889),u_x_56891,u_y_56892,u_z_56893);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1477762307995