...
return cljs.core.merge.call(null,initial_state,p1__47195_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_47196 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_47197 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_47196);
var pos_47198 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_47196);
quil.core.scale.call(null,zoom_47197);

var tr__37049__auto___47199 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_47197) - cljs.core.first.call(null,pos_47198)),(((quil.core.height.call(null) / (2)) / zoom_47197) - cljs.core.second.call(null,pos_47198))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__37049__auto___47199);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1479783414842