...
return (function (p1__56900_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__56900_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_56901 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_56902 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_56901);
var pos_56903 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_56901);
quil.core.scale.call(null,zoom_56902);

var tr__41538__auto___56904 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_56902) - cljs.core.first.call(null,pos_56903)),(((quil.core.height.call(null) / (2)) / zoom_56902) - cljs.core.second.call(null,pos_56903))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__41538__auto___56904);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1477762308058