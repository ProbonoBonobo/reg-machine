...
var len__5619__auto___31534 = arguments.length;
var i__5620__auto___31535 = (0);
while(true){
if((i__5620__auto___31535 < len__5619__auto___31534)){
args__5626__auto__.push((arguments[i__5620__auto___31535]));

var G__31536 = (i__5620__auto___31535 + (1));
i__5620__auto___31535 = G__31536;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31533){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31533));
});
/**
...
var args__5626__auto__ = [];
var len__5619__auto___31543 = arguments.length;
var i__5620__auto___31544 = (0);
while(true){
if((i__5620__auto___31544 < len__5619__auto___31543)){
args__5626__auto__.push((arguments[i__5620__auto___31544]));

var G__31545 = (i__5620__auto___31544 + (1));
i__5620__auto___31544 = G__31545;
continue;
} else {
}
break;
...
var vec__31549 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__31549,(0),null);
var names = cljs.core.nth.call(null,vec__31549,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__31549,tag_name,names){
return (function (p1__31546_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__31546_SHARP_));
});})(matches,vec__31549,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__31549,tag_name,names){
return (function (p1__31547_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__31547_SHARP_));
});})(matches,vec__31549,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__31550){
var vec__31553 = p__31550;
var tag = cljs.core.nth.call(null,vec__31553,(0),null);
var content = cljs.core.nthnext.call(null,vec__31553,(1));
...
var vec__31554 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__31554,(0),null);
var id = cljs.core.nth.call(null,vec__31554,(1),null);
var class$ = cljs.core.nth.call(null,vec__31554,(2),null);
