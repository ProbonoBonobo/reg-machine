...
var or__4561__auto__ = cljs.core.last.call(null,cljs.core.sort.call(null,cljs.core.map.call(null,(function (p1__27860_SHARP_){
return p1__27860_SHARP_.length();
...
var args27861 = [];
var len__5619__auto___27864 = arguments.length;
var i__5620__auto___27865 = (0);
while(true){
if((i__5620__auto___27865 < len__5619__auto___27864)){
args27861.push((arguments[i__5620__auto___27865]));

var G__27866 = (i__5620__auto___27865 + (1));
i__5620__auto___27865 = G__27866;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args27861.length)].join('')));
