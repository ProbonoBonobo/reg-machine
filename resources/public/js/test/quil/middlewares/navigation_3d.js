...
var vec__31206 = axis;
var a_x = cljs.core.nth.call(null,vec__31206,(0),null);
var a_y = cljs.core.nth.call(null,vec__31206,(1),null);
var a_z = cljs.core.nth.call(null,vec__31206,(2),null);
var vec__31207 = v;
var x = cljs.core.nth.call(null,vec__31207,(0),null);
var y = cljs.core.nth.call(null,vec__31207,(1),null);
var z = cljs.core.nth.call(null,vec__31207,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__31208,p__31209){
var vec__31212 = p__31208;
var u1 = cljs.core.nth.call(null,vec__31212,(0),null);
var u2 = cljs.core.nth.call(null,vec__31212,(1),null);
var u3 = cljs.core.nth.call(null,vec__31212,(2),null);
var vec__31213 = p__31209;
var v1 = cljs.core.nth.call(null,vec__31213,(0),null);
var v2 = cljs.core.nth.call(null,vec__31213,(1),null);
var v3 = cljs.core.nth.call(null,vec__31213,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__31214_SHARP_){
return (p1__31214_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__31215_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__31216_SHARP_,angle_lr),angle_ud);
...
var map__31223 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__31223__$1 = ((((!((map__31223 == null)))?((((map__31223.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31223.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31223):map__31223);
var up = cljs.core.get.call(null,map__31223__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__31223__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__31225 = cljs.core._EQ_;
var expr__31226 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__31225.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__31226))){
return straight;
} else {
if(cljs.core.truth_(pred__31225.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__31226))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__31225.call(null,quil.middlewares.navigation_3d.space,expr__31226))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__31225.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__31226))){
return up;
} else {
if(cljs.core.truth_(pred__31225.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__31226))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__31225.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__31226))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__31223,map__31223__$1,up,straight){
return (function (p1__31217_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__31217_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__31223,map__31223__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__31228_SHARP_);
});})(initial_state))
);
});
/**
...
var map__31234_31239 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__31234_31240__$1 = ((((!((map__31234_31239 == null)))?((((map__31234_31239.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31234_31239.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31234_31239):map__31234_31239);
var vec__31235_31241 = cljs.core.get.call(null,map__31234_31240__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_31242 = cljs.core.nth.call(null,vec__31235_31241,(0),null);
var c_y_31243 = cljs.core.nth.call(null,vec__31235_31241,(1),null);
var c_z_31244 = cljs.core.nth.call(null,vec__31235_31241,(2),null);
var vec__31236_31245 = cljs.core.get.call(null,map__31234_31240__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_31246 = cljs.core.nth.call(null,vec__31236_31245,(0),null);
var u_y_31247 = cljs.core.nth.call(null,vec__31236_31245,(1),null);
var u_z_31248 = cljs.core.nth.call(null,vec__31236_31245,(2),null);
var vec__31237_31249 = cljs.core.get.call(null,map__31234_31240__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_31250 = cljs.core.nth.call(null,vec__31237_31249,(0),null);
var p_y_31251 = cljs.core.nth.call(null,vec__31237_31249,(1),null);
var p_z_31252 = cljs.core.nth.call(null,vec__31237_31249,(2),null);
quil.core.camera.call(null,p_x_31250,p_y_31251,p_z_31252,(p_x_31250 + c_x_31242),(p_y_31251 + c_y_31243),(p_z_31252 + c_z_31244),u_x_31246,u_y_31247,u_z_31248);
