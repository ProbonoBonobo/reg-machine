...
var vec__30980 = axis;
var a_x = cljs.core.nth.call(null,vec__30980,(0),null);
var a_y = cljs.core.nth.call(null,vec__30980,(1),null);
var a_z = cljs.core.nth.call(null,vec__30980,(2),null);
var vec__30981 = v;
var x = cljs.core.nth.call(null,vec__30981,(0),null);
var y = cljs.core.nth.call(null,vec__30981,(1),null);
var z = cljs.core.nth.call(null,vec__30981,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__30982,p__30983){
var vec__30986 = p__30982;
var u1 = cljs.core.nth.call(null,vec__30986,(0),null);
var u2 = cljs.core.nth.call(null,vec__30986,(1),null);
var u3 = cljs.core.nth.call(null,vec__30986,(2),null);
var vec__30987 = p__30983;
var v1 = cljs.core.nth.call(null,vec__30987,(0),null);
var v2 = cljs.core.nth.call(null,vec__30987,(1),null);
var v3 = cljs.core.nth.call(null,vec__30987,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__30988_SHARP_){
return (p1__30988_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__30989_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__30990_SHARP_,angle_lr),angle_ud);
...
var map__30997 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__30997__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__30997__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__30999 = cljs.core._EQ_;
var expr__31000 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__30999.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__31000))){
return straight;
} else {
if(cljs.core.truth_(pred__30999.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__31000))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__30999.call(null,quil.middlewares.navigation_3d.space,expr__31000))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__30999.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__31000))){
return up;
} else {
if(cljs.core.truth_(pred__30999.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__31000))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__30999.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__31000))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__30997,map__30997__$1,up,straight){
return (function (p1__30991_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__30991_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__30997,map__30997__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__31002_SHARP_);
});})(initial_state))
);
});
/**
...
var map__31008_31013 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__31008_31014__$1 = ((((!((map__31008_31013 == null)))?((((map__31008_31013.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31008_31013.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31008_31013):map__31008_31013);
var vec__31009_31015 = cljs.core.get.call(null,map__31008_31014__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_31016 = cljs.core.nth.call(null,vec__31009_31015,(0),null);
var c_y_31017 = cljs.core.nth.call(null,vec__31009_31015,(1),null);
var c_z_31018 = cljs.core.nth.call(null,vec__31009_31015,(2),null);
var vec__31010_31019 = cljs.core.get.call(null,map__31008_31014__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_31020 = cljs.core.nth.call(null,vec__31010_31019,(0),null);
var u_y_31021 = cljs.core.nth.call(null,vec__31010_31019,(1),null);
var u_z_31022 = cljs.core.nth.call(null,vec__31010_31019,(2),null);
var vec__31011_31023 = cljs.core.get.call(null,map__31008_31014__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_31024 = cljs.core.nth.call(null,vec__31011_31023,(0),null);
var p_y_31025 = cljs.core.nth.call(null,vec__31011_31023,(1),null);
var p_z_31026 = cljs.core.nth.call(null,vec__31011_31023,(2),null);
quil.core.camera.call(null,p_x_31024,p_y_31025,p_z_31026,(p_x_31024 + c_x_31016),(p_y_31025 + c_y_31017),(p_z_31026 + c_z_31018),u_x_31020,u_y_31021,u_z_31022);
