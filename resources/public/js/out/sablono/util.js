...
var m__19857__auto__ = (sablono.util.to_str[goog.typeOf(x__19856__auto__)]);
if(!((m__19857__auto__ == null))){
return m__19857__auto__.call(null,x);
} else {
var m__19857__auto____$1 = (sablono.util.to_str["_"]);
...
var x__19856__auto__ = (((x == null))?null:x);
var m__19857__auto__ = (sablono.util.to_uri[goog.typeOf(x__19856__auto__)]);
if(!((m__19857__auto__ == null))){
return m__19857__auto__.call(null,x);
} else {
var m__19857__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19857__auto____$1 == null))){
return m__19857__auto____$1.call(null,x);
} else {
...
var len__20259__auto___40068 = arguments.length;
var i__20260__auto___40069 = (0);
while(true){
if((i__20260__auto___40069 < len__20259__auto___40068)){
args__20266__auto__.push((arguments[i__20260__auto___40069]));

var G__40070 = (i__20260__auto___40069 + (1));
i__20260__auto___40069 = G__40070;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__20267__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq40067){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq40067));
});
/**
...
var vec__40072 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__40072,(0),null);
var words = cljs.core.nthnext.call(null,vec__40072,(1));
...
var G__40074 = clojure.set.rename_keys.call(null,m,kmap);
var G__40074__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__40074,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__40074);
return G__40074__$1;
} else {
return m;
}
...
var args__20266__auto__ = [];
var len__20259__auto___40077 = arguments.length;
var i__20260__auto___40078 = (0);
while(true){
if((i__20260__auto___40078 < len__20259__auto___40077)){
args__20266__auto__.push((arguments[i__20260__auto___40078]));

var G__40079 = (i__20260__auto___40078 + (1));
i__20260__auto___40078 = G__40079;
continue;
} else {
}
break;
...
var argseq__20267__auto__ = ((((0) < args__20266__auto__.length))?(new cljs.core.IndexedSeq(args__20266__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__20267__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__40075_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__40075_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__40075_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__40075_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq40076){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq40076));
});
/**
...
var vec__40083 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__40083,(0),null);
var names = cljs.core.nth.call(null,vec__40083,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__40083,tag_name,names){
return (function (p1__40080_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__40080_SHARP_));
});})(matches,vec__40083,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__40083,tag_name,names){
return (function (p1__40081_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__40081_SHARP_));
});})(matches,vec__40083,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__40084){
var vec__40087 = p__40084;
var tag = cljs.core.nth.call(null,vec__40087,(0),null);
var content = cljs.core.nthnext.call(null,vec__40087,(1));
...
var vec__40088 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__40088,(0),null);
var id = cljs.core.nth.call(null,vec__40088,(1),null);
var class$ = cljs.core.nth.call(null,vec__40088,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__19201__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1444632663030